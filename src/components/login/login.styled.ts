...
export const LoginContainer = styled.div(tw`w-screen h-screen bg-neutral-50`);
export const LoginWrapper = styled.div(
  tw`flex flex-col gap-5 items-center justify-center w-full h-full`
);
export const ContentBox = styled.div(
  tw`flex flex-col gap-4 h-1/2 w-1/3 p-6 bg-white border border-neutral-200 rounded-2xl shadow-lg`
);
...
export const FormButton = styled.div(
  tw`w-full px-4 py-2 text-center text-white bg-blue-700 rounded-xl cursor-pointer`
);
