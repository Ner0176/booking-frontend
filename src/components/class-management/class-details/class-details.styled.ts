...
export const EditAttendeesButton = styled.button(
  tw`flex flex-row items-center gap-0.5 px-2 sm:px-3 py-1.5 sm:py-2 whitespace-nowrap text-violet-600 rounded-xl border border-violet-600 cursor-pointer`
);
