...
export const AttendeesListWrapper = styled.div(
  tw`col-span-2 flex flex-col gap-3 pt-4 px-10`
);
export const EditAttendeesButton = styled.button(
  tw`flex flex-row items-center gap-0.5 px-3 py-2 whitespace-nowrap text-violet-600 rounded-xl border border-violet-600 cursor-pointer`
);
