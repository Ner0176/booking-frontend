...
export const StyledButton = styled.div<{
  ...
  ${tw`flex items-center justify-center text-sm sm:text-base px-4 py-2 sm:py-2.5 min-w-[75px] sm:min-w-[100px] sm:min-h-[45px] whitespace-nowrap border border-neutral-200 rounded-full cursor-pointer`}
